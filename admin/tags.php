...
<div class="mainwrapper">
    ...
    <div class="rightpanel">
        ...
        <div class="pagetitle">
        	<h1>Create Google Analytics Tag</h1> <span>This is a sample description for form styles page...</span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
        	<div class="contentinner">
            	<h4 class="widgettitle">Create Google Analytics Tag Form</h4>
                <div class="widgetcontent">              	
                    <!-- START OF TABBED WIZARD -->
                    <form class="stdform" method="post" action="create-tag.php" enctype="multipart/form-data" >
                    <div id="wizard2" class="wizard tabbedwizard">
                        <ul class="tabbedmenu">
                            <li>
                            	<a href="#wiz1step2_1">
                                	<span class="h2">STEP 1</span>
                                    <span class="label">Enter Google Analytics tag</span>
                                </a>
                            </li>
							<li>
                            	<a href="#wiz1step2_2">
                                	<span class="h2">STEP 2</span>
                                    <span class="label">Enter tag parameters</span>
                                </a>
                            </li>
							<li>
                            	<a href="#wiz1step2_3">
                                	<span class="h2">STEP 3</span>
                                    <span class="label">Enter tag url</span>
                                </a>
                            </li>
							<li>
                            	<a href="#wiz1step2_4">
                        ...
                        <div id="wiz1step2_1" class="formwiz">
                        	<h4>Step 1: Enter Google Analytics tag</h4>
                                <p>
                                    <label>Textarea with Character Count</label>
										<span class="field">
											<textarea cols="80" name="tag_text" rows="5" id="textarea2" class="span5"></textarea>
										</span>
                                </p>
                        </div><!--#wiz1step2_1-->
						
						<div id="wiz1step2_2">
                        	<h4>Step 2: Enter tag parameters</h4>
								<p>
                                    <label>Tag status</label>
                                    <span class="field">
										<select name="status" id="status" <?php /*class="uniformselect"*/ ?> >
						...
						<div id="wiz1step2_3">
                        	<h4>Step 3: Enter tag url</h4>
                                <p>
                                    <label>Quizzes</label>
                                    <span class="field">
										<input type="url" name="tag_url" id="tag_url" class="input-xxlarge" required="required" />
                                    </span>
                                </p>
                        </div><!--#wiz1step2_3-->
						
						<div id="wiz1step2_4">
                        	<h4>Step 4: Setup Quizzes</h4>
                                <p>
                                    <label>Quizzes</label>
                                    <span class="field">
