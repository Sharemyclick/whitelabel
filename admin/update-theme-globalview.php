...
if(isset($_POST) && !empty($_POST)){
    foreach($_POST as $indPost => $valPost){
        ...
        {
            $bdd->exec('DELETE FROM themes WHERE id='.$_POST['id']);
            $bdd->exec('DELETE FROM template_themes WHERE themes_id='.$_POST['id']); 
        }
    }
}
        ...
        <div class="maincontent">
            ...
            <table class="table table-bordered" id="dbase">
					...
					while ($theme = $reqTheme->fetch())
						{?>
                        <tr><form class="stdform" method="post" action="update-theme.php?id=<?php echo $theme['id'];?>">

                            <td class="centeralign" ><a href="update-theme.php?id=<?php echo $theme['id'];?>">
                                ...
                                while ($admin= $reqAdmin->fetch())
						{
                          ...
                          <!--'LEFT JOIN answers_questions ON answers_questions.questions_id=questions.id LEFT JOIN answers ON answers.id=answers_questions.answers_id '-->
                            ...
                            <td class="centeralign" >
                                <form  id="form-delete-<?php echo $theme['id']; ?>" name="form-delete-<?php echo $theme['id']; ?>" method="post" action="">
                                  <a href="#"  class="deleterowcustomized"><span id="delete<?php echo $theme['id']; ?>" class="icon-trash"></span></a>
                                  <input type="hidden" name="hidden_delete<?php echo $theme['id']; ?>" value="" >
